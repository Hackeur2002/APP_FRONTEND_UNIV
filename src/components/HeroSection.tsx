...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-screen bg-gradient-to-br from-blue-900 to-blue-700 text-white">
      {/* Navigation */}
      <nav className="absolute top-0 left-0 right-0 z-10 px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#contact" className="px-4 py-2 bg-white bg-opacity-10 hover:bg-opacity-20 rounded-full transition-colors">
              Contact
            </a>
          </div>
          ...
          {/* Overlay menu mobile */}
          {menuOpen && (
            <div className="fixed inset-0 bg-blue-900 bg-opacity-95 z-10 flex flex-col items-center justify-center space-y-8 text-xl">
        ...
        <div className="mx-auto h-full flex flex-col justify-center items-center text-center px-6">
          ...
          >
            Vos documents universitaires en quelques clics
          </motion.h1>
          ...
          >
            Obtenez rapidement vos diplômes, relevés et attestations sans vous déplacer
          </motion.p>
          ...
          >
            <a
              href="#demande"
              className="px-8 py-3 bg-white text-blue-700 font-semibold rounded-lg hover:bg-gray-100 transition-colors flex items-center justify-center"
            >
              Faire une demande <ArrowRight className="ml-2" />
            </a>
            <a
              href="#services"
              className="px-8 py-3 border border-white text-white font-semibold rounded-lg hover:bg-white hover:bg-opacity-10 transition-colors"
            >
              Nos services
            </a>
          </motion.div>
